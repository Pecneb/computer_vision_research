...
előrejelző rendszerek ifejlesztése egy nagy kihívás és egyre növekszik irántuk a kereslet. Ebben a kutatásban erre a problémára törekszünk
megoldást adni, gépi látás, gépi tanulás és konvolúciós neurális háló segítségével. Objektumok detektálására a YOLOv7 \cite{wang2022yolov7}
konvolúciós neurális hálót használtuk. Objektumok felismerése egyedülálló képkockákon manapság már nem olyan nagy fealdat, sok pontos
objektum detektáló modellt fejlesztettek ki, de videók elemzésénél nem csak a pontosság hanem a sebesség is egy szempont. Emellett
képkockáról képkockára követni is kell tudni a detektált objektumokat. Erre is sok megoldás található manapság, erre a feladatra
