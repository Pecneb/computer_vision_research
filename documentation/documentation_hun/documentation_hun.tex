...
kapjunk fals klasztereket.
\subsubsection{Trajektóriák kiválasztása}
Az objektum detektálás és követés nem tökéletes, rossz fényviszonyok, hosszabb eltakará-sok miatt a trajektóriák megszakadhatnak
ezért ki kell válasz-tani az egyben maradt trajektóriákat. Első soron kiválasztjuk azokat, amelyek belépési és kilépési pontjai
a kép relatív széleitől egy meghatározott határértékre vannak. 
\subsubsection{DeepSORT pontatlanság}
Kutatásunk során azt tapasztaltuk, hogy a DeepSORT és a YOLO pontatlanságai felerősí-tik egymást. A YOLO hajlamos néha táblákat
vagy rendőr-lámpákat autóknak nézni, és ekkor a DeepSORT is elkezdi követni. Egy olyan hibáját is felfedeztük a DeepSORT-nak, hogy
...
paramétereit, ami nem bizonyult akkora javulásnak, ezért útólagos szűréssel kellett korrigálnunk ezt a hibát. ...
...
létre, de a kifejlesztett szűrő hatékonyab-bnak bizonyult, ezért maradtunk a 4 dimenziós feature vektorok mellett. (lásd ...)
\subsection{Klaszterezési algoritmusok}
A legjobb eredményeket az OPTICS \cite{10.1145/304181.304187} algoritmus adta. ...
