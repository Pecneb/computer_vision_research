...
van kirajzolva (lásd \ref{BellevueNewportRealTimeSVM}). Az alkalmazás futását a mellékletben megadott videókon lehet megtekinteni.

\begin{figure}[H]
    \Description{Bellevue Newport}
    \includegraphics[width=1\columnwidth]{visualization/bellevue_newport.png}
    \caption{Bellevue Newport SVM real time application}
    \label{BellevueNewportRealTimeSVM}
\end{figure}

\begin{figure}[H]
    \Description{Bellevue NE kereszteződés}
    \includegraphics[width=1\columnwidth]{visualization/bellevue_ne.png}
    \caption{Bellevue NE SVM real time application}
    \label{fig: BellevueNERealTimeSVM}
\end{figure}

\begin{figure}[H]
    \Description{Bellevue Eastgate kereszteződés}
    \includegraphics[width=1\columnwidth]{visualization/bellevue_eastgate.png}
    \caption{Bellevue Eastgate SVM real time application}
    \label{fig: BellevueEeatgateRealTimeSVM}
\end{figure}
