...
A több klasszos klasszifikálás egy olyan feladat, amikor több mint 2 klassz van, és minden feature vektor csak egy klasszba tartozhat.
Ez kevesebb klassz számnál jó eredeményt adhat, de a mi esetünkben ahol 10-15 klassz is lehet, ami azt jelenti, hogy nem lehet elérni nagy
pontosságot. Ennyi klassz közül nehéz pontosan eltatlálni melyik klasszba tartozik egy trajektória.
\subsection{Binary}
...
Binráris klasszifikációs modellek kombinációjából, egy több klasszos modellt állítottunk össze, ami átlagban 90\%-os feletti pontossággal tudta előre
...
A KNN átlagban 5\% al adott jobb eredményt mint az SVM

\begin{table}
\begin{center}
\begin{tabular}{ | c | c | c | }
   \hline 
   \multicolumn{3}{|c|}{Binary Model Accuracy Features v1} \\
   \hline
   \hline
   Metrics              & KNN               & SVM       \\
   \hline
   Base Accuracy        & 96.75\%           & 90.86\%   \\
   \hline
   Balanced Accuracy    & 95.75\%           & 84.52\%   \\
   \hline
   Top 1 Accuracy       & 96.75\%           & 90.82\%   \\
   \hline
   Top 2 Accuracy       & 99.30\%           & 98.03\%   \\
   \hline
\end{tabular}
\caption[Binary version 1 feature vectors]{Binary modell verzió 1-es feature vektorokkal mért pontossága}
\label{table:1}
\end{center}
\end{table}
...
\begin{tabular}{ | c | c | c | }
   \hline 
   \multicolumn{3}{|c|}{Binary Model Accuracy Features v7} \\
   \hline
   \hline
   Metrics              & KNN               & SVM       \\
   \hline
   Base Accuracy        & 96.66\%           & 96.16\%   \\
   \hline
   Balanced Accuracy    & 93.61\%           & 92.18\%   \\
   \hline
   Top 1 Accuracy       & 96.64\%           & 92.16\%   \\
   \hline
   Top 2 Accuracy       & 99.39\%           & 98.90\%   \\
   \hline
\end{tabular}
\end{center}
\caption[Binary version 7 feature vectors]{Binary modell verzió 7-es feature vektorokkal mért pontossága}
\label{table:2}
\end{table}

\subsection{Feature vektorok}
Ahogyan klaszterezésnél is, fontos meghatározni egy olyan feature vektort, ami a legjobban jellemzi a trajektóriát. 7 fajta
feature vektorral teszteltük a kiválasztott klasszifikációs modelleket, a legjobban az 1. és 7. verzió teljesített. (lásd \ref{table:1} \ref{table:2})
