...
A következő képeken láthatók a klaszterek szűrés előtt és után. A koordinátákl plottolása mellett, hisztogramot is készítettünk,
hogy lássuk a trajektóriák hosszának változását.
\begin{figure}[H]
 \Description{Klaszterezés szűrés előtt}
 \includegraphics[width=1\columnwidth]{clustering/n_cluster_0_n_tracks_1280.png}
 \caption{KlaszterV1 1}
 \label{fig: KlaszterV1_0}   
\end{figure}
\begin{figure}[H]
 \Description{Klaszterezés szűrés után}
 \includegraphics[width=1\columnwidth]{clustering/n_cluster_0_n_tracks_933.png}
 \caption{KlaszterV2 1}
 \label{fig: KlaszterV2_0}   
\end{figure}
\begin{figure}[H]
 \Description{Klaszterezés szűrés előtt}
 \includegraphics[width=1\columnwidth]{clustering/n_cluster_4_n_tracks_235.png}
 \caption{KlaszterV1 2}
 \label{fig: KlaszterV1_4}   
\end{figure}
\begin{figure}[H]
 \Description{Klaszterezés szűrés előtt}
 \includegraphics[width=1\columnwidth]{clustering/n_cluster_5_n_tracks_130.png}
 \caption{KlaszterV2 2}
 \label{fig: KlaszterV2_4}   
\end{figure}
...
A legjobb eredményeket az OPTICS (Ordering Points To Identify the Clustering Structure) \cite{10.1145/304181.304187} algoritmus adta. 
Aminek az eredményei fenti képeken látható (lásd. \ref{fig: KlaszterV1_0} \ref{fig: KlaszterV2_0} \ref{fig: KlaszterV1_4} \ref{fig: KlaszterV2_4}).
Ez az algoritmus megkeresi a nagy sűrűségű halmazokat az adathalmazban, majd fokozatossan bővíti őket.
...
\subsection{Binary}
A bináris klasszifikáció a többklasszossal szemben, csak 2 klassz között dönt. 2 klassz között sokkal pontosabban el lehet dönteni,
hogy a feature vektor melyikbe tartozik. 
\subsection{OneVsRest}
Binráris klasszifikációs modellek kombinációjából, egy több klasszos modellt állítottunk össze, ami ... \%-al pontosabb eredményt adott.
...
...
\subsection{Feature vektorok}
Ahogyan klaszterezésnél is, fontos meghatározni egy olyan feature vektort, ami a legjobban jellemzi a trajektóriát. 7 fajta
feature vektorral teszteltük a kiválasztott klasszifikációs modelleket, a legjobban az 1. és 7. verzió teljesített. ...
...
amit ezért használtunk, hogy az adathalmaz kiegyensúlyozatlansága miatt ne kapjunk fals pontosságot. Ha minden klasszra egyenlően jól teljesít a klasszifikációs modellünk, akkor a sima \emph{Accuracy}-t kapjuk vissza.
Ha a teszt adathalmaz kiegyensúlyozatlansága miatt az egyik klassznak jobb a pontossága mint egy másiknak, akkor ezt az értéket
elosztja a klasszok számával. Ha az \begin{math}y_i\end{math} a valódi értéke az \begin{math}i\end{math}. mintának, és
