...
\begin{math}v_x = \frac{v_{x_0}}{w} * r\end{math}, \begin{math}v_y = \frac{v_{y_0}}{w} * r\end{math}, \begin{math}a_x = \frac{a_{x_0}}{w} * r\end{math}, \begin{math}a_y = \frac{a_{y_0}}{w} * r\end{math}
...
\paragraph{A másik verzió} Felépítése \begin{math}x_0, y_0, v_{x_0}, v_{y_0}, x_m, y_m\\, x_l, y_l, v_{x_l}, v_{y_l}]\end{math}
